...
import AddBookModal, { EditBookModal } from "../components/StockManager/Modals/AddBookModal";
...
const StockManager = () => {
  ...
  const loadAllData = useCallback(() => {
    ...
    if (storedAuthors) setAuthors(Array.isArray(storedAuthors) ? storedAuthors : []);
  }, []);
