...
const OrderConfirmation = () => {
  ...
  useEffect(() => {
    ...
    if (foundOrder) {
      ...
      const updates = getTrackingUpdates(foundOrder.id);
      setTrackingUpdates(updates);

      const orderedCategories = getOrderedCategories(foundOrder, books);
      const recommendations = getRecommendedBooks(orderedCategories, books, 4);
